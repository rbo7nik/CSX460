...
f <- function(x) {
  ...
  # The for loop wil execute 4 times, appending 
  # the product of all the elements of x, except
  # it's current index. I achieved that by using
  # the negative index notation, which returns
  # all the elements but the negative index
  for(i in 1:length(x)) {
    m[i] = prod(x[-i])
  }
  m 
